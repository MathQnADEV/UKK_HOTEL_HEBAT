import { RESEPSIONIS_LIST } from "@/components/constant";
import CheckInCheckOut from "@/components/resepsionis/CheckInCheckOut";
import { useRouter } from "next/router";

export default function resepsionis() {
            ...
            <nav className="w-full fixed top-0 z-50">
                ...
                >
                    ...
                    <ul className="flex text-white">
                        {RESEPSIONIS_LIST.map((menu, index) => {
                            return (
                                <li
                                    key={index}
