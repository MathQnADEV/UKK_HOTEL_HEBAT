...
import { FASILITAS_KAMAR } from '../constant'

const AdminFasilitasKamar = () => {
    return (
                ...
                <div className="bg-white mx-auto w-full h-auto rounded-xl">
                    <div className="relative overflow-x-auto">
                        <table className="w-full text-sm text-left text-gray-500 mt-3">
                            ...
                            <tbody>
                                {FASILITAS_KAMAR.map((name, index) => {
                                    return (
                                        <tr class="bg-white border-b" key={index}>
                                            ...
                                            <td class="px-6 py-4">{name.Fasilitas}</td>
...
export default AdminFasilitasKamar